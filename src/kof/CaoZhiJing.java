...
public class CaoZhiJing implements Player{
    ...
    static {
        for (int i = 0; i < 10; i++) {
            standImgs[i] = GameUtil.getImage("kof/images/caozhijing/stand/0-" + i + ".png");
    ...
    static {
        downImgs = GameUtil.getImage("kof/images/caozhijing/down/6-2.png");
        downImgs.getWidth(null);
        for (int i = 0; i < 9; i++) {
            downKImgs[i] = GameUtil.getImage("kof/images/caozhijing/downk/0-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 11; i++) {
            afterImgs[i] = GameUtil.getImage("kof/images/caozhijing/after/0-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 11; i++) {
            beforeImgs[i] = GameUtil.getImage("kof/images/caozhijing/before/0-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 5; i++) {
            beatenImgs[i] = GameUtil.getImage("kof/images/caozhijing/beaten/0-" + i + ".png");
    ...
    static Image afterJImg = GameUtil.getImage("kof/images/caozhijing/afterj/1-1.png");

    static {
        for (int i = 0; i < 2; i++) {
            jImgs[i] = GameUtil.getImage("kof/images/caozhijing/j/0-" + i + ".png");
            jImgs[i].getWidth(null);
        }
        for (int i = 0; i < 6; i++){
            beforeJImgs[i] = GameUtil.getImage("kof/images/caozhijing/beforej/0-" + i + ".png");
            beforeJImgs[i].getWidth(null);
        }
        for (int i = 0; i < 7; i++){
            afterJImgs[i] = GameUtil.getImage("kof/images/caozhijing/afterj/0-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 4; i++) {
            kImgs[i] = GameUtil.getImage("kof/images/caozhijing/k/0-" + i + ".png");
            kImgs[i].getWidth(null);
        }
        for (int i = 0; i < 5; i++) {
            afterKImgs[i] = GameUtil.getImage("kof/images/caozhijing/afterk/0-" + i + ".png");
            afterKImgs[i].getWidth(null);
        }
        for (int i = 0; i < 10; i++) {
            beforeKImgs[i] = GameUtil.getImage("kof/images/caozhijing/beforek/2-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 6; i++) {
            lImgs1[i] = GameUtil.getImage("kof/images/caozhijing/l/0-" + i + ".png");
            lImgs1[i].getWidth(null);
        }
        for (int i = 0; i < 6; i++) {
            lImgs2[i] = GameUtil.getImage("kof/images/caozhijing/l/1-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 10; i++) {
            uImgs1[i] = GameUtil.getImage("kof/images/caozhijing/u/0-" + i + ".png");
            uImgs1[i].getWidth(null);
        }
        for (int i = 0; i < 10; i++) {
            uImgs2[i] = GameUtil.getImage("kof/images/caozhijing/u/1-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 17; i++) {
            iImgs[i] = GameUtil.getImage("kof/images/caozhijing/i/0-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 9; i++) {
            flyImgs[i] = GameUtil.getImage("kof/images/caozhijing/fly/0-" + i + ".png");
