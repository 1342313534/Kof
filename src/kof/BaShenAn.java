...
public class BaShenAn implements Player {
    ...
    static {
        for (int i = 0; i < 18; i++) {
            if (i>8){
                standImgs[i] = GameUtil.getImage("kof/images/bashenan/stand/0-" + (17-i) + ".png");
            }else{
                standImgs[i] = GameUtil.getImage("kof/images/bashenan/stand/0-" + i + ".png");
            }
    ...
    static {
        for (int i = 0; i < 6; i++) {
            downImgs[i] = GameUtil.getImage("kof/images/bashenan/down/11-" + (i+1) + ".png");
            downImgs[i].getWidth(null);
        }
        for (int i = 0; i < 11; i++) {
            downKImgs[i] = GameUtil.getImage("kof/images/bashenan/downk/0-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 9; i++) {
            afterImgs[i] = GameUtil.getImage("kof/images/bashenan/after/21-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 9; i++) {
            beforeImgs[i] = GameUtil.getImage("kof/images/bashenan/before/21-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 4; i++) {
            beatenImgs[i] = GameUtil.getImage("kof/images/bashenan/beaten/0-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 4; i++) {
            jImgs[i] = GameUtil.getImage("kof/images/bashenan/j/1-" + i + ".png");
            jImgs[i].getWidth(null);
        }
        for (int i = 0; i < 8; i++){
            afterJImgs[i] = GameUtil.getImage("kof/images/bashenan/afterj/0-" + i + ".png");
            afterJImgs[i].getWidth(null);
        }
        for (int i = 0; i < 8; i++){
            beforeJImgs[i] = GameUtil.getImage("kof/images/bashenan/beforej/0-" + i + ".png");
            beforeJImgs[i].getWidth(null);
        }
        for (int i = 0; i < 8; i++){
            beforeJImgs2[i] = GameUtil.getImage("kof/images/bashenan/beforej/1-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 4; i++) {
            kImgs[i] = GameUtil.getImage("kof/images/bashenan/k/0-" + i + ".png");
            kImgs[i].getWidth(null);
        }
        for (int i = 0; i < 10; i++) {
            afterKImgs[i] = GameUtil.getImage("kof/images/bashenan/afterk/0-" + i + ".png");
            afterKImgs[i].getWidth(null);
        }
        for (int i = 0; i < 9; i++) {
            beforeKImgs[i] = GameUtil.getImage("kof/images/bashenan/beforek/0-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 9; i++) {
            lImgs1[i] = GameUtil.getImage("kof/images/bashenan/l/1-" + i + ".png");
            lImgs1[i].getWidth(null);
        }
        for (int i = 0; i < 1; i++) {
            lImgs2[i] = GameUtil.getImage("kof/images/bashenan/l/9-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 18; i++) {
            if (i>=13){
                uImgs1[i] = GameUtil.getImage("kof/images/bashenan/u/5-" + 13 + ".png");
            }else{
                uImgs1[i] = GameUtil.getImage("kof/images/bashenan/u/5-" + (i+1) + ".png");

            }
            uImgs2[i] = GameUtil.getImage("kof/images/bashenan/u/6-" + i + ".png");
    ...
    static {
        for (int i = 0; i < 18; i++) {
            iImgs[i] = GameUtil.getImage("kof/images/bashenan/i/4-" + (i+1) + ".png");
    ...
    static {
        for (int i = 0; i < 9; i++) {
            flyImgs[i] = GameUtil.getImage("kof/images/bashenan/fly/0-" + i + ".png");
